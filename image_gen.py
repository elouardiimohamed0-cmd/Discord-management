...
class ImageGenerator:
    ...
    def generate_player_card(self, player: PlayerStats, position: str = "CM", 
                            club_name: str = "Rachad L3ERGONI", division: int = 6) -> io.BytesIO:
        W, H = 600, 900
        ...
        draw.text((W//2, 90), f"Division {division} • Pro Clubs Tracker", fill=self.SILVER, font=font_small, anchor="mm")
