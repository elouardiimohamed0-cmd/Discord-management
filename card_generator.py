...
CARD_SCHEMES = {
    "gold_metal": CardColors(
        bg_top=(212, 175, 55), bg_bottom=(139, 90, 43), accent=(255, 215, 0),
        text_primary=(30, 20, 10), text_secondary=(80, 60, 30),
        stat_bar_fill=(255, 215, 0), stat_bar_bg=(60, 45, 20),
        glow=(255, 215, 0, 120),
    ),
    "purple_blue_energy": CardColors(
        bg_top=(75, 0, 130), bg_bottom=(0, 0, 139), accent=(138, 43, 226),
        text_primary=(240, 240, 255), text_secondary=(180, 180, 220),
        stat_bar_fill=(138, 43, 226), stat_bar_bg=(30, 20, 60),
        glow=(138, 43, 226, 180),
    ),
    "green_neon": CardColors(
        bg_top=(0, 100, 0), bg_bottom=(0, 50, 0), accent=(50, 205, 50),
        text_primary=(240, 255, 240), text_secondary=(150, 220, 150),
        stat_bar_fill=(50, 205, 50), stat_bar_bg=(20, 40, 20),
        glow=(50, 205, 50, 140),
    ),
    "blue_lock_king": CardColors(
        bg_top=(0, 0, 80), bg_bottom=(0, 0, 40), accent=(65, 105, 225),
        text_primary=(220, 230, 255), text_secondary=(150, 170, 220),
        stat_bar_fill=(0, 191, 255), stat_bar_bg=(20, 30, 60),
        glow=(0, 191, 255, 200),
    ),
    "clown_circus": CardColors(
        bg_top=(180, 50, 50), bg_bottom=(100, 20, 20), accent=(255, 0, 0),
        text_primary=(255, 240, 240), text_secondary=(220, 150, 150),
        stat_bar_fill=(255, 80, 80), stat_bar_bg=(60, 20, 20),
        glow=(255, 0, 0, 150),
    ),
    "ghost_transparent": CardColors(
        bg_top=(100, 100, 110), bg_bottom=(60, 60, 70), accent=(200, 200, 210),
        text_primary=(240, 240, 245), text_secondary=(180, 180, 190),
        stat_bar_fill=(200, 200, 210), stat_bar_bg=(50, 50, 60),
        glow=(255, 255, 255, 80),
    ),
    "toty": CardColors(
        bg_top=(0, 40, 80), bg_bottom=(0, 20, 40), accent=(0, 191, 255),
        text_primary=(220, 240, 255), text_secondary=(150, 190, 220),
        stat_bar_fill=(0, 191, 255), stat_bar_bg=(20, 30, 50),
        glow=(0, 191, 255, 180),
    ),
    "tots": CardColors(
        bg_top=(0, 80, 60), bg_bottom=(0, 40, 30), accent=(0, 255, 127),
        text_primary=(220, 255, 240), text_secondary=(150, 220, 180),
        stat_bar_fill=(0, 255, 127), stat_bar_bg=(20, 50, 40),
        glow=(0, 255, 127, 160),
    ),
}
...
def _add_noise(img: Image.Image, intensity: int = 5) -> Image.Image:
    ...
    for y in range(h):
        for x in range(w):
            ...
            noise_pixels[x, y] = (128 + val, 128 + val, 128 + val)
...
class CardGenerator:
    ...
    def _get_scheme(self, aura_tier: AuraTier) -> CardColors:
        cfg = AURA_CONFIGS.get(aura_tier)
        if not cfg:
            return CARD_SCHEMES["gold_metal"]
        return CARD_SCHEMES.get(cfg.card_bg, CARD_SCHEMES["gold_metal"])
