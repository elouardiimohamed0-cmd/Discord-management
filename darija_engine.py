...
PHRASE_DB = {
    "roast_low_rating": PhraseTemplate(
        ...
        [
            ...
            "wakha a khay {nickname}, {rating}? كتبان f terain b7al chi far9a f l3ers.",
    ...
    "roast_zero_stats": PhraseTemplate(
        ...
        [
            ...
            "{nickname} a 3chiri, {stat}={value}? كتبان b7al chi 7wayej f terain.",
    ...
    "roast_high_possession_lost": PhraseTemplate(
        ...
        [
            ...
            "a {nickname}, {value} possession lost? حتى chi zbel ماشي بحالك f terain.",
            "{nickname} ya zamel, {value}? كتدي lball l3nd l5or أكثر من l3ayel ديالو.",
            "wakha {nickname}, possession lost {value}? آش هاد الكارثة؟",
            "{nickname} a 3chiri, {value} possession lost? كتبان b7al chi 7wayej.",
    ...
    "praise_mvp": PhraseTemplate(
        ...
        [
            ...
            "a {nickname}, {stat}={value}? س7اب ل3ب، كتبان ب7ال فراري f terain.",
    ...
    "stat_of_day_mvp": PhraseTemplate(
        ...
        [
            ...
            "STAT OF THE DAY: {nickname} - {stat}={value}. a {nickname}, كتبان b7ال فراري f terain.",
    ...
    "command_error": PhraseTemplate(
        "roast",
        [
            "a 7mar, command ماشي صحيح. واش كتقرأ ولا كتشوف b7al chi 3ayel?",
...
class DarijaEngine:
    ...
    def add_casablanca_flavor(self, text: str) -> str:
        prefixes = [
            "wakha a khay, ", "a 3chiri, ", "yak a sidi, ", "oh lala, ",
            "a 7bibi, ", "wakha, ",
        ]
        suffixes = [
            " سير تعلم ل3b.", " حتى l3ayel ديال derb sultan كيلعب أحسن.",
            " آش هاد الكارثة?", " rating ديالك محتاج محامي.",
            " واش كنتي لاعب ولا جا غير السميّة ديالك?",
        ]
    ...
    def roast(self, player, pos: str = "CM") -> str:
        """Compatibility method: roast a PlayerStats object."""
        nickname = player.name if hasattr(player, 'name') else str(player)
        stats = {
            "games": getattr(player, 'games', 1) or 1,
            "rating": getattr(player, 'rating_pg', 7.0) or 7.0,
            ...
            "impact": getattr(player, 'impact_score', 5.0) or 5.0,
        }
        return self.roast_player(nickname, stats)
